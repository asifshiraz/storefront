...
export function Pagination({
	...
	return (
		<nav className="flex items-center justify-center gap-x-4 border-border px-4 pt-12">
			<Link
				href={pageInfo.hasPreviousPage ? prevPageUrl : "#"}
				className={clsx("px-4 py-2 text-sm font-medium", {
					"hover:bg-primary/90 rounded bg-primary text-primary-foreground": pageInfo.hasPreviousPage,
					"cursor-not-allowed border text-muted-foreground": !pageInfo.hasPreviousPage,
			...
			<Link
				...
				className={clsx("px-4 py-2 text-sm font-medium", {
					"hover:bg-primary/90 rounded bg-primary text-primary-foreground": pageInfo.hasNextPage,
					"cursor-not-allowed border text-muted-foreground": !pageInfo.hasNextPage,
