...
export const OrderListItem = ({ order }: Props) => {
	return (
		<li className="bg-card">
			<div className="bg-muted/40 flex flex-col gap-2 border px-6 py-4 md:grid md:grid-cols-4 md:gap-8">
				...
				<div className="flex flex-col md:col-span-1 md:flex-row md:items-center lg:col-span-2">
					<LinkWithChannel
						...
						className="flex items-center justify-center rounded border border-input bg-card px-4 py-2 text-sm hover:bg-secondary focus:bg-secondary md:ml-auto"
					>
						View Order
					</LinkWithChannel>
				</div>
